...
async addToolbarShell() : Promise<null> {
    return await TAURI_INVOKE("add_toolbar_shell");
},
async removeToolbarShell() : Promise<null> {
    return await TAURI_INVOKE("remove_toolbar_shell");
},
