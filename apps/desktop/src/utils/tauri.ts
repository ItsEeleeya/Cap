...
export type MagnifierSegment = { start: number; end: number; enabled?: boolean; center?: XY<number>; radius?: number; zoomAmount?: number; shape?: MagnifierShape; glassStrength?: number; glassRadius?: number; borderWidth?: number; borderColor?: string; feather?: number }
export type MagnifierShape = "circle" | "ellipse" | "roundedRectangle"
...
export type TimelineConfiguration = { segments: TimelineSegment[]; zoomSegments: ZoomSegment[]; sceneSegments?: SceneSegment[]; maskSegments?: MaskSegment[]; textSegments?: TextSegment[]; magnifierSegments?: MagnifierSegment[] }
