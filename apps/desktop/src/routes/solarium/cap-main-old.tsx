...
function TargetMenuPanel(props: TargetMenuPanelProps & SharedTargetMenuProps) {
	...
	return (
		<div class="flex flex-col w-full h-full min-h-0">
			<div class="px-2 custom-scroll flex-1 overflow-y-auto pt-12">
				{props.variant === "display" ? (
					<TargetMenuGrid
						variant="display"
	...
	return (
		<div class="apple-glass rounded-[20px] flex relative flex-col h-full min-h-0 text-(--text-primary) pl-3">
			<div
				...
				class="h-12.5 w-full flex items-center relative"
			>
				<Transition
					mode="outin"
				...
				>
					<Show
						...
						fallback={
							<div
								class="flex items-center w-fit p-2 apple-glass rounded-full"
								data-tauri-drag-region
							>
									...
									fallback={
										<div class="flex gap-2 items-center">
											...
											<button
												...
												class="flex gap-1.5 items-center rounded-md px-2 py-1 text-xs font-medium text-gray-11 transition-colors hover:text-gray-12 hover:bg-gray-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-9 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-1"
											>
