...
export default function SystemAudio() {
	return (
		<SystemAudioToggleRoot
			class="apple-glass flex overflow-hidden relative z-10 flex-row gap-2 items-center px-3 w-full h-[42px] rounded-2xl transition-colors cursor-default disabled:opacity-70 disabled:text-gray-11 KSelect"
