...
function TargetTypeButton(props: TargetTypeButtonProps) {
	...
	return (
		<button
			...
			class={cx(
				"flex flex-1 flex-col items-center justify-end gap-2 rounded-xl bg-gray-3/25 py-2.5 text-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-9 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-1",
