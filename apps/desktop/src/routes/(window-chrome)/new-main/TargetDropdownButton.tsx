...
>(props: TargetDropdownButtonProps<T>) {
	...
	return (
		<Polymorphic
			...
			class={cx(
				"flex h-[4rem] w-5 shrink-0 items-center justify-center bg-gray-4/10 text-gray-12 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-9 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-1 hover:bg-gray-5",
