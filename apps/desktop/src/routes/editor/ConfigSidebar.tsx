...
export function ConfigSidebar() {
  ...
  return (
    <KTabs
      ...
      class="flex flex-col min-h-0 shrink-0 flex-1 max-w-[26rem] overflow-hidden rounded-xl z-10 relative glass shadow-none"
    >
      <KTabs.List class="flex overflow-hidden sticky top-0 z-[60] flex-row items-center h-16 text-lg border-b border-gray-3 shrink-0">
        <For
          each={[
