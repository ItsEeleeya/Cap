...
export function Player() {
  ...
  return (
    <div class="flex flex-col flex-1 rounded-xl border bg-gray-1 dark:bg-gray-2 border-gray-3">
      ...
      <PreviewCanvas />
      <div class="flex overflow-hidden z-10 flex-row gap-3 justify-between items-center p-5 py-3">
        <div class="flex-1">
          <Time
            class="text-gray-12"
            seconds={Math.max(
        ...
        <div class="flex flex-row items-center justify-center text-gray-11 gap-8 text-[0.875rem]">
          ...
          <Tooltip kbd={["Space"]} content="Play/Pause video">
            <button
              ...
              class="flex justify-center items-center rounded-full  transition-colors bg-none hover:bg-gray-4hover:text-black size-9 z-50"
              style={{
