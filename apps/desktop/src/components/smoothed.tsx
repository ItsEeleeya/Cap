...
interface SmoothedHandle {
    sync: (geo: GeoOpts, borderColor: string) => void;
    disconnect: () => void;
}

function smoothedObserver(
    el: HTMLElement,
    initialGeo: GeoOpts,
...
export const Smoothed = <T extends ValidComponent = "div">(
    ...
    const userRef = (props as { ref?: (el: HTMLElement | undefined) => void }).ref;
