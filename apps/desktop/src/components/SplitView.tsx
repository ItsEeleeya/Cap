...
const SplitView = <T extends ValidComponent = "div">(
...
const Handle = <T extends ValidComponent = "button">(
...
SplitView.Panel = ResizablePrimitive.Panel;
SplitView.Handle = Handle;
