...
- **Never edit generated files**: `**/tauri.ts`, `**/queries.ts`, `apps/desktop/src-tauri/gen/**`, `packages/ui-desktop/src/auto-imports.d.ts`, Drizzle migration SQL under `packages/database/migrations/`.
...
- Turborepo monorepo:
  ...
  - `packages/*` shared libs (e.g., `database`, `ui`, `ui-desktop`, `utils`, `web-*`).
