...
const styles = cva(
	"outline-offset-2 outline-2 flex justify-center items-center focus-visible:outline rounded-full transition-all will-change-transform duration-200",
	{
		...
		variants: {
			variant: {
				primary:
					"bg-gray-12 text-gray-1 disabled:bg-gray-6 disabled:text-gray-9 apple-glass dark-button-shadow",
				blue: "bg-blue-600 text-white border border-blue-800 shadow-[0_1.50px_0_0_rgba(255,255,255,0.20)_inset] hover:bg-blue-700  disabled:bg-gray-6 disabled:text-gray-9 apple-glass",
				destructive:
					"bg-red-500 text-white hover:bg-red-600 disabled:bg-red-200 apple-glass",
				outline:
				...
				gray: "bg-gray-5 data-[selected=true]:!bg-gray-8 dark:data-[selected=true]:!bg-gray-9 hover:bg-gray-7 border gray-button-border gray-button-shadow text-gray-12 disabled:bg-gray-8 disabled:text-gray-9 apple-glass",
